...
if(status==="success")
{
    ...
    dispatch({type:'EMPTY'});
    props.history.push('/');
    toast.success("you have paid succeffully now you can continue shopping",{position: toast.POSITION.TOP_RIGHT});
}
...
console.log(response);
    ...
    return(
            ...
            <div className="cart-details" style={{marginTop:'100px'}}>
               ...
               shoppingCart.map(cart =>(
                   <div className="cart" key={cart.id}>
                       ...
                       <span className="cart-product-name">{cart.name}.00</span>
        ...
        :<div className="empty">'sorry cart is empty '</div>}
      ...
      {shoppingCart.length > 0 ? <div className="cart-summary">
          <div className="summary">
              ...
              <div className="stripe-section">
                   <StripeCheckout
                     stripeKey="pk_test_51HeCoWDDOubwGrciHNktgFks6o2CqmRaT1NXSoA5ykLsyvasETqo5yuM5Z2DMDlKoyByPjx1PS3LwIjt9d9t3otO00vJuEBmt4"
                     token={handleToken}  
